package com.wh.gaea.interfaces.input;
...
import com.wh.gaea.control.grid.GridCellEditor;
import com.wh.gaea.control.grid.GridCellEditor.ActionResult;
import com.wh.gaea.control.grid.GridCellEditor.ButtonActionListener;
	...
	TableInput(JComponent parent) {
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (sType == SelectType.stSelect && table.getSelectedRow() == -1) {
					MsgHelper.showMessage(TableInput.this, "请先选择一项数据！", "提示",
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (MsgHelper.showConfirmDialog("是否删除选定的条目？", "",
