...
public abstract class FlowNode extends DrawNode {
	...
	public FlowNode(IDrawCanvas canvas) {
		super(canvas);
	}
	...
	protected void drawText(Graphics g) {
		g.setColor(Color.DARK_GRAY);
		IDrawNode.drawText(g, font, getRect(), new StringBuilder(title == null ? "" : title));
	}
	...
	public static class BeginNode extends FlowNode{
		...
		public BeginNode(IDrawCanvas canvas) {
			super(canvas);
		}
		...
		protected void drawNode(Graphics g){
			...
			IDrawNode.drawText(g, font, rect, new StringBuilder(title == null ? "" : title));
		}
	...
	public static class ChildFlowNode extends FlowNode{
		...
		public ChildFlowNode(IDrawCanvas canvas) {
			super(canvas);
		}
	...
	public static class EndNode extends FlowNode{
		...
		public EndNode(IDrawCanvas canvas) {
			super(canvas);
		}
	...
	public static class LabelNode extends FlowNode{
		...
		public LabelNode(IDrawCanvas canvas) {
			super(canvas);
		}
		...
		protected void drawText(Graphics g) {
			g.setColor(Color.DARK_GRAY);
			IDrawNode.drawText(g, font, Color.BLACK, getRect(), new StringBuilder(title == null ? "" : title));
		}

	}
	
	public static class ProcessNode extends FlowNode{
		public ProcessNode(IDrawCanvas canvas) {
			super(canvas);
		}
	...
	public static class StateNode extends FlowNode{
		public StateNode(IDrawCanvas canvas) {
			super(canvas);
		}
	...
	public static class ActionNode extends ProcessNode{
		public ActionNode(IDrawCanvas canvas) {
			super(canvas);
		}
		...
		public JSONObject toJson() throws JSONException{
			...
			json.put("role", role == null ? new JSONArray() : role.toJson());
			json.put("memo", memo == null ? "" : memo);
		...
		public void fromJson(JSONObject json, ICreateNodeSerializable createUserDataSerializable) throws JSONException{
			...
			if (json.has("role"))
				role = new RoleInfos(json.getJSONArray("role"));
			else
				role = null;
	...
	public static class SwitchNode extends FlowNode{
		public SwitchNode(IDrawCanvas canvas) {
			super(canvas);
		}
	...
	public static class ConditionNode extends FlowNode{
		public ConditionNode(IDrawCanvas canvas) {
			super(canvas);
		...
		protected void drawText(Graphics g) {
			g.setColor(Color.DARK_GRAY);
			IDrawNode.drawMulitText(g, font, Color.WHITE, getRect(), title == null ? "" : title);
		}
	}

	public static class ORNode extends SwitchNode{
		public ORNode(IDrawCanvas canvas) {
			super(canvas);
		}
	...
	public static class XORNode extends ORNode{
		public XORNode(IDrawCanvas canvas) {
			super(canvas);
		}
	...
	public static class ANDNode extends ORNode{
		public ANDNode(IDrawCanvas canvas) {
			super(canvas);
		}
