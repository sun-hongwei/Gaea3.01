...
public class ScrollBarInfo extends DrawInfo{
	public String typeName(){
		return IDrawInfoDefines.ScrollBar_Name;
	}

	public ScrollBarInfo(IUINode node) {
		super(node);
		width = "100%";
		height = "200px";
	}
	...
	public void drawNode(Graphics g, Rectangle rect){		
		IDrawNode.drawLineText(g, getFont(), textColor, rect.x, rect.y, rect.width, rect.height, "：" + name);
	}
