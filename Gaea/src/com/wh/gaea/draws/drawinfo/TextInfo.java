...
public class TextInfo extends DrawInfo {
	...
	public String typeName() {
		return IDrawInfoDefines.TextBox_Name;
	}

	public TextInfo(IUINode node) {
		super(node);
		width = "150px";
		height = "24px";
	}
	...
	protected int getTextHeight(Graphics g, String text) {
		return IDrawNode.getTextHeight(g, getFont(), text);
	}
	...
	protected int drawItem(Graphics g, int x, int y, int width, int height, boolean autoHeight, boolean needCenter,
		...
		int textHeight = IDrawNode.drawLineText(g, getFont(), textColor, textLeft, y, textWidth,
